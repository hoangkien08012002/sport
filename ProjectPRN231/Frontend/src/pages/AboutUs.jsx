      ...
      <div className="mt-44 mx-[20%] flex">
        <div className="w-1/2 justify-center flex flex-col ml-10 mr-10">
          <div className="mb-10">
            ...
            <h1 className="text-[35px] font-bold text-black">HighSportShop</h1>
            <p className="text-[15px] text-[#6A6A6A] mt-3 text-wrap">
              HighSportShop is always the address providing hot secondhand products,
              ...
              addition, HighSportShop is also willing to buy, sell and consign limited
          ...
          <div className="bg-[#EEEEEE] p-[10%]">
            ...
            <p className="text-[15px] text-[#6A6A6A] mt-3 mb-5">
              HighSportShop is committed to bringing convenience and cost-effectiveness
              to sports lovers, by providing a trustworthy platform to shop for
              quality and valuable secondhand sportswear. With the name HighSportShop,
          ...
          <div className="relative mb-10">
            ...
            <div className="absolute bottom-12 left-8 transform translate-y-1/4 text-white">
              ...
              <p className="text-lg mt-3 text-left">
                "HighSportShop is committed to bringing the best quality products and
